import{b as V,c as X,a as B,d as Y}from"./DpHeg7sK.js";import{h as d,a as P,e as x,aX as Z,b as J,E as K,aO as Q,O as U,N as p,d as L,c as y,n as $,L as ee,aY as te,aZ as ie,p as se,q as oe,f as ne,v as r,i as re,a_ as ae,w as le,g as ce,A as g,a$ as de,b0 as O}from"./Dt3yZA6t.js";import{d as T,a as he}from"./Bg-qcqfR.js";import{e as ue,i as fe}from"./CeT-oxNe.js";import{f as ge}from"./DLX0iCAC.js";import{B as be}from"./CE69xkab.js";import{p as h,r as we}from"./C7eBRDwH.js";function ke(t,e,n,i,w,S){let k=d;d&&P();var o=null;d&&x.nodeType===Z&&(o=x,P());var u=d?x:t,f=new be(u,!1);J(()=>{const l=e()||null;var m=te;if(l===null){f.ensure(null,null);return}return f.ensure(l,s=>{if(l){if(o=d?o:Q(l,m),V(o,o),i){var c=null;d&&ge(l)&&o.append(c=document.createComment(""));var a=d?U(o):o.appendChild(p());d&&(a===null?L(!1):y(a)),i(o,a),c?.remove()}$.nodes.end=o,s.before(o)}d&&y(s)}),()=>{}},K),ee(()=>{}),k&&(L(!0),y(u))}/**
 * @file
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Se=Symbol("lucide-context"),me=()=>ie(Se);var Ne=new Set(["$$slots","$$events","$$legacy","color","size","width","height","strokeWidth","absoluteStrokeWidth","nonScalingStroke","iconNode","icon","class","children"]),xe=Y("<svg><!><!></svg>");function Le(t,e){se(e,!0);const n=me()??{},i=h(e,"color",19,()=>n.color??"currentColor"),w=h(e,"size",19,()=>n.size??24),S=h(e,"width",19,w),k=h(e,"height",19,w),o=h(e,"strokeWidth",19,()=>n.strokeWidth??2),u=h(e,"absoluteStrokeWidth",19,()=>n.absoluteStrokeWidth??!1),f=h(e,"nonScalingStroke",19,()=>n.nonScalingStroke??!1),l=h(e,"iconNode",19,()=>[]),m=h(e,"icon",19,()=>({node:l(),aliases:[],size:24})),s=we(e,Ne),c=g(()=>!!e.children||_e(s)),a=g(()=>ve(m(),{color:i(),width:S(),height:k(),strokeWidth:o(),absoluteStrokeWidth:u(),nonScalingStroke:f(),className:A("lucide-icon",n.class),hasA11yProp:r(c),attributes:s})),v=g(()=>O(r(a),3)),_=g(()=>r(v)[1]),I=g(()=>de(r(v)[2],()=>[],!0)),j=g(()=>({...r(_),class:[...r(_).class.split(" "),e.class]}));var N=xe();T(N,()=>({...r(j)}));var C=oe(N);ue(C,17,()=>r(I),fe,(F,M)=>{var z=g(()=>O(r(M),2));let R=()=>r(z)[0],q=()=>r(z)[1];var E=X(),G=ne(E);ke(G,R,!0,(H,ye)=>{T(H,()=>({...q()}))}),B(F,E)});var D=re(C);he(D,()=>e.children??ae),le(N),B(t,N),ce()}export{Le as I};

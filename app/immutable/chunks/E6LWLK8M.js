import"./NZTpNUN0.js";import{G as d,H as E,a8 as m,aG as K,J as V,aa as X,aH as Y,aI as q,aJ as Q,a9 as U,a1 as Z,a6 as P,a7 as y,D as $,O as p,aK as ee,Y as te,p as se,a as j,b as ie,i as oe,s as ne,X as re,j as r,v as ae,f as le,aD as ce,r as de,u as g,aL as he,aM as D}from"./CBpStvL0.js";import{j as I,e as ue,g as fe,h as ge}from"./bo9Tym9i.js";import{B as we}from"./B8cfkzUp.js";import{p as h,r as be}from"./LWPt358a.js";function ke(t,e,n,s,b,S){let k=d;d&&E();var o=null;d&&m.nodeType===K&&(o=m,E());var u=d?m:t,f=new we(u,!1);V(()=>{const a=e()||null;var N=n||a==="svg"?ee:void 0;if(a===null){f.ensure(null,null);return}return f.ensure(a,i=>{if(a){if(o=d?o:Y(a,N),q(o,o),s){var c=null;d&&Q(a)&&o.append(c=document.createComment(""));var l=d?U(o):o.appendChild(Z());d&&(l===null?P(!1):y(l)),s(o,l),c?.remove()}$.nodes.end=o,i.before(o)}d&&y(i)}),()=>{}},X),p(()=>{}),k&&(P(!0),y(u))}/**
 * @file
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Se=Symbol("lucide-context"),Ne=()=>te(Se);var xe=new Set(["$$slots","$$events","$$legacy","color","size","width","height","strokeWidth","absoluteStrokeWidth","nonScalingStroke","iconNode","icon","class","children"]),me=re("<svg><!><!></svg>");function Ee(t,e){se(e,!0);const n=Ne()??{},s=h(e,"color",19,()=>n.color??"currentColor"),b=h(e,"size",19,()=>n.size??24),S=h(e,"width",19,b),k=h(e,"height",19,b),o=h(e,"strokeWidth",19,()=>n.strokeWidth??2),u=h(e,"absoluteStrokeWidth",19,()=>n.absoluteStrokeWidth??!1),f=h(e,"nonScalingStroke",19,()=>n.nonScalingStroke??!1),a=h(e,"iconNode",19,()=>[]),N=h(e,"icon",19,()=>({node:a(),aliases:[],size:24})),i=be(e,xe),c=g(()=>!!e.children||_e(i)),l=g(()=>ve(N(),{color:s(),width:S(),height:k(),strokeWidth:o(),absoluteStrokeWidth:u(),nonScalingStroke:f(),className:C("lucide-icon",n.class),hasA11yProp:r(c),attributes:i})),v=g(()=>D(r(l),3)),_=g(()=>r(v)[1]),L=g(()=>he(r(v)[2],()=>[],!0)),T=g(()=>({...r(_),class:[...r(_).class.split(" "),e.class]}));var x=me();I(x,()=>({...r(T)}));var z=oe(x);ue(z,17,()=>r(L),ge,(O,F)=>{var A=g(()=>D(r(F),2));let G=()=>r(A)[0],H=()=>r(A)[1];var B=ae(),J=le(B);ke(J,G,!0,(R,ye)=>{I(R,()=>({...H()}))}),j(O,B)});var M=ne(z);fe(M,()=>e.children??ce),de(x),j(t,x),ie()}export{Ee as I,ke as e};
